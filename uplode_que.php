...
// ૧. ડેટાબેઝ કનેક્શન
$host = "localhost";
$user = "u725553512_2801_db"; // ડેટાબેઝ યુઝરનામ
$pass = "Jigscse@123"; // ડેટાબેઝ પાસવર્ડ
$dbname = "u725553512_2801_db";   // ડેટાબેઝનું નામ

$conn = new mysqli($host, $user, $pass, $dbname);


// ૨. તમારા પ્રશ્નોનું લિસ્ટ
$questions_array = [
    [
        "category" => "pvp",
        "q" => "What is a good FICO credit score range?",
        "opt" => ["300-500", "580-669", "670-739", "800-850"],
        "ans" => 2,
    ...
    [
        ...
        "opt" => ["Annual Percentage Rate", "Annual Payment Ratio", "Average Price Rate", "Amortized Payment Rate"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Equifax", "Chase", "Wells Fargo", "Visa"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Your total income", "The percentage of available credit you use", "The number of cards you own", "Your bank balance"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A card with no limit", "A card requiring a security deposit", "A card for business only", "A card with 0% interest"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["The amount the insurer pays you", "The amount you pay for the policy", "A discount for safe driving", "A tax on your car"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A discount", "The amount you pay before insurance starts paying", "The total payout", "The annual fee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Damage to your own car", "Damage and injuries you cause to others", "Theft of your vehicle", "Natural disasters"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for your whole life", "Insurance for a specific period of time", "Insurance for home damage", "Insurance for health bills"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for one year", "Lifetime coverage with a cash-value savings component", "Health insurance", "Car insurance"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A car loan", "A loan to purchase real estate", "A personal loan", "A business grant"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Private Mortgage Insurance", "Personal Money Interest", "Primary Mortgage Installment", "Public Money Investment"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Selling a property", "Taking a new loan to pay off an old one with better terms", "Repairing a house", "Paying taxes"],
        "ans" => 1,
    ...
    [
        "category" => "pvp",
        "q" => "What is 'Equity'?",
        "opt" => ["The total house price", "The difference between market value and mortgage balance", "The size of the land", "A type of insurance"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A bank for savings", "A neutral account holding funds for taxes and insurance", "A credit card for builders", "A government tax"],
        "ans" => 1,
    ...
    [
        "category" => "pvp",
        "q" => "What is 'Bitcoin'?",
        "opt" => ["A physical gold coin", "A decentralized digital currency", "A government bank", "A type of stock"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A physical chain", "A distributed ledger technology", "A bank software", "A crypto wallet name"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Sell quickly", "Hold onto a cryptocurrency for the long term", "A type of new coin", "A trading platform"],
        "ans" => 1,
    ...
    [
        "category" => "crypto",
        "q" => "What is an 'NFT'?",
        "opt" => ["New Finance Tool", "Non-Fungible Token", "National Funding Trust", "Network File Transfer"],
        "ans" => 1,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'Ethereum'?",
        "opt" => ["A gas company", "A blockchain with smart contract functionality", "A digital bank", "A type of loan"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Actual Intelligence", "Artificial Intelligence", "Automated Information", "Advanced Integration"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Weather app", "Computing services delivered over the internet", "A type of battery", "Software for pilots"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Locking office doors", "Protecting systems and networks from digital attacks", "A bank security guard", "Computer hardware"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A factory robot", "A branch of AI that learns from data to improve accuracy", "Teaching kids", "A high-speed printer"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'SaaS'?",
        "opt" => ["Software as a Service", "System Account", "Simple Apple", "Standard Asset"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Hiring staff", "Legal disputes that arise when a person suffers harm from an accident", "Buying a house", "Tax law"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A case with one person", "A lawsuit where a group of people collectively sues a party", "A legal test for students", "A sports penalty"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A very strong lawyer", "Legal authority to act on another person's behalf", "A high credit score", "A government law"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A new business plan", "Negligence by a professional (like a doctor or lawyer)", "A type of tax", "A bank fee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying a house", "Creations of the mind, like inventions and art", "Money in the bank", "A type of car"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Tax on your salary", "Tax paid by someone who inherits money or property", "A tax on gifts", "A property tax"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A tax refund check", "An expense that reduces your taxable income", "A penalty for late filing", "A tax on luxury items"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Internal Revenue Service", "International Revenue System", "Internal Reporting System", "Individual Revenue Service"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Your salary", "Profit from the sale of an investment or property", "A bank loan", "The interest on a savings account"],
        "ans" => 1,
    ...
    [
        "category" => "pvp",
        "q" => "What is 'VAT'?",
        "opt" => ["Value Added Tax", "Variable Asset Tax", "Verified Account Tool", "Valid Annual Tax"],
        "ans" => 0,
    ...
    [
        "category" => "marketing",
        "q" => "What is 'SEO'?",
        "opt" => ["Social Economic Order", "Search Engine Optimization", "System Entry Option", "Standard Email Operation"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Back to Business", "Business to Business", "Bank to Business", "Business to Bank"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A company that failed", "A private company valued at over \$1 billion", "A company that sells toys", "A business with 1 employee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying a new business", "Earning a commission by promoting products", "Trading stocks", "Hiring staff"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Emailing customers", "Buying and selling goods or services using the internet", "A type of bank account", "Electronic communication"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Working only at night", "Working from a location other than a central office", "Working for free", "A type of manual labor"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Making money fast", "Operating without harming the environment", "Closing a company", "Hiring more staff"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying computers", "Integrating digital tech into all business areas", "Using Facebook", "Internet tax"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Digging for gold", "The process of discovering patterns in large data sets", "Deleting old files", "A type of bank theft"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'Fintech'?",
        "opt" => ["Financial Technology", "Final Tech", "Finance and Teaching", "Finnish Tech"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Total bank deposits", "Total value of goods and services produced in a country", "Total tax collected", "The country's population"],
        "ans" => 1,
    ...
    [
        "category" => "gk",
        "q" => "What is 'Inflation'?",
        "opt" => ["Prices falling", "Increase in prices and decrease in purchasing power", "Stable economy", "New money"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'Net Worth'?",
        "opt" => ["Annual salary", "Total assets minus total liabilities", "Money in bank", "House value"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A bank loan", "A portion of company profits paid to shareholders", "A tax on stocks", "The cost of a share"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A bank loan", "Financing provided to startups with high growth potential", "Retirement savings", "A type of tax"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bogey", "Birdie", "Eagle", "Albatross"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Mercedes", "Red Bull", "Ferrari", "McLaren"],
        "ans" => 2,
    ...
    [
        ...
        "opt" => ["The number of players", "The probability of an event and potential payout", "The length of the game", "The ticket price"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Golf", "Tennis", "Cricket", "Baseball"],
        "ans" => 1,
    ...
    [
        "category" => "gaming",
        "q" => "What is 'eSports'?",
        "opt" => ["Outdoor sports", "Competitive video gaming", "Sports played by robots", "Electronic gym equipment"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying a house", "Getting compensation after an accident", "Starting a business", "Writing a will"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A holiday bonus", "Insurance providing benefits to employees injured at work", "A monthly salary", "A gift from the boss"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying fake medicine", "Professional negligence by a healthcare provider", "A type of insurance", "A bank fee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Measuring health", "Determining creditworthiness for loans", "Voting in elections", "Tracking internet speed"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling a house", "Replacing an old loan with a new one for a lower rate", "Painting the house", "Buying land"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling small amounts of stock", "Betting that a stock price will fall", "Buying stocks for one day", "Giving shares as a gift"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Storing physical cash", "Storing private keys to access cryptocurrency", "Paying for groceries in a shop", "Tracking bank balances"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Department of Finance", "Decentralized Finance", "Digital File", "Defined Finality"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Losing half your money", "An event that cuts mining rewards by 50% every 4 years", "A bank fee", "Selling crypto"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Software as a Service", "System and Account Secure", "Simple Apple System", "Standard Asset Software"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["A sport with a rod", "Fraudulent attempt to obtain sensitive info via email", "A type of fast internet", "Deleting old files"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Storing files on a USB", "Web hosting using multiple virtual servers to balance load", "Weather forecasting", "A type of satellite TV"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for old cars", "Covers the difference between car value and loan balance", "Insurance for the tires only", "A discount for new drivers"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Health Maintenance Organization", "High Medical Option", "Home Medical Office", "Hospital Management Order"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["The Open", "US Open", "The Masters", "PGA Championship"],
        "ans" => 2,
    ...
    [
        ...
        "opt" => ["Winning three races", "Betting on the first three finishers in exact order", "A three-mile race", "The name of a horse"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Betting at the stadium", "Placing bets on a sports event while it is in progress", "Betting on a video game", "Betting with friends"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paris", "Monte Carlo", "London", "Nice"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A type of penalty", "A single bet that links two or more individual wagers", "A player's salary", "A meeting between coaches"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["The company's total profit", "Ratio of annual dividend to current share price", "The cost of a share", "A bank fee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying taxes", "A company's efforts to improve society and environment", "Hiring more employees", "Buying office buildings"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Video Assistant Referee", "Virtual Area Review", "Variable Action Rate", "Video Action Replay"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Grass", "Hard Court", "Clay", "Carpet"],
        "ans" => 2,
    ...
    [
        "category" => "investing",
        "q" => "What is 'Arbitrage'?",
        "opt" => ["A legal penalty", "Simultaneous buying and selling to profit from price differences", "A type of stock insurance", "Long-term investing"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling all assets", "Dividing a portfolio among different asset categories like stocks and bonds", "Buying a house", "Paying taxes"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Phishing'?",
        "opt" => ["A sport with a rod", "Fraudulent attempt to obtain sensitive info by disguising as a trustworthy entity", "A type of fast internet", "Deleting old files"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Hiring staff", "Legal harm or injury to a person's body or mind", "Buying a house", "Tax law"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Most Valuable Player", "Main Venue Position", "Major Value Participant", "Minimum Variable Point"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Buying stocks", "Automatically selling at a set price to limit loss", "Stopping all trades", "Double profit"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A type of tax", "Using borrowed funds to increase a trading position", "Buying without a broker", "Investing in gold"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Home trading", "Illegal trading based on non-public information", "Trading only in local stocks", "Trading by bank employees"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Criminal Lawyer", "Personal Injury Lawyer", "Corporate Lawyer", "Divorce Lawyer"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling a product", "Legal responsibility for injuries caused by defective products", "A business tax", "A bank fee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Professional bones", "Legal work done for free for the public good", "A type of insurance", "A high court fee"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is a 'HELOC'?",
        "opt" => ["High Energy Loan", "Home Equity Line of Credit", "Home Estate Loan", "Helpful Emergency Loan"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying only interest", "Spreading loan payments over a period of time", "A type of insurance", "A bank penalty"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Personal Money Investment", "Insurance that protects the lender if the borrower defaults", "A property tax", "A loan fee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A loan with fixed interest", "A mortgage where interest rates can change over time", "A loan for cars", "A zero-interest loan"],
        "ans" => 1,
    ...
    [
        "category" => "realestate",
        "q" => "What is 'Escrow'?",
        "opt" => ["A type of house", "A neutral third party holding funds during a transaction", "A high interest rate", "A legal penalty"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["The Longest Race", "The Most Exciting Two Minutes in Sports", "The Golden Cup", "The Horse Marathon"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A type of dinner", "A bet on the margin of victory", "The number of players", "A sports ticket"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["London", "Singapore", "New York", "Paris"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A bet on the final score", "A bet on specific events within a game (e.g., first scorer)", "A type of team name", "A coach's decision"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Building cars", "Calculating risks and premiums in insurance", "Designing software", "Teaching sports"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Covers only theft", "Covers non-collision damage like fire or vandalism", "Covers the other driver only", "A minimum legal requirement"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Covers your injuries", "Covers damage you cause to others", "Covers theft", "Insurance for your house"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling small amounts", "Betting that a stock price will fall", "Buying stocks for one day", "Giving shares as a gift"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["The city where the market is", "Total value of a company's outstanding shares", "Total daily profit", "The interest rate"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Electronic Transfer", "A fund that tracks an index and trades like a stock", "A type of bank account", "Early Trade Finance"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'EBITDA'?",
        "opt" => ["Earnings Before Interest, Taxes, Depreciation, and Amortization", "Every Business Income", "Electronic Bank Data", "Early Business Investment"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["A coin made of gold", "A cryptocurrency pegged to a stable asset like the US Dollar", "A type of horse", "A bank's internal coin"],
        "ans" => 1,
    ...
    [
        "category" => "mba",
        "q" => "What is 'CRM'?",
        "opt" => ["Customer Relationship Management", "Cash Return Management", "Corporate Risk", "Customer Review"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["The speed of a website", "The percentage of visitors who take a desired action", "The price of a product", "A tax rate"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paris", "Dubai", "New York", "London"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["A type of bank loan", "The legal obligation to act in another's best interest", "A high credit score", "A tax on travel"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Trading in forests", "The exchange of one currency for another", "A stock market index", "Buying gold"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Long Term Value", "Loan-to-Value ratio", "Large Tax Verification", "Low Total Variable"],
        "ans" => 1,
    ...
    [
        "category" => "tax",
        "q" => "What is 'DTI' ratio?",
        "opt" => ["Debt-to-Income ratio", "Daily Tax Income", "Direct Total Interest", "Digital Trade Index"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Writing a book", "The process of assessing the risk of a potential borrower", "Painting a house", "A home inspection"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'Dividend'?",
        "opt" => ["A type of bank loan", "A portion of company profits paid to shareholders", "A tax on stocks", "The price of a share"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["High inflation and high growth", "High inflation combined with stagnant economic growth", "Low inflation", "A stable market"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A bank's internal policy", "Government use of spending and taxation to influence the economy", "Policy for hiring new staff", "A law about trade unions"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Policy for office culture", "Actions taken by a central bank to manage money supply and interest rates", "A tax on luxury goods", "A law about trade unions"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Government intervention", "Free market with minimal government interference", "Socialist economy", "High taxation"],
        "ans" => 1,
    ...
    [
        "category" => "realestate",
        "q" => "What is 'Asset'?",
        "opt" => ["Money you owe", "A resource with economic value that an individual or corporation owns", "A tax paid to government", "A monthly expense"],
        "ans" => 1,
    ...
    [
        "category" => "insurance",
        "q" => "What is 'Liability'?",
        "opt" => ["Something you own", "Something you owe to another party", "Total cash in hand", "A high profit margin"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Total investment in building", "Current assets minus current liabilities", "The amount paid to workers", "Money used for luxury cars"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Current price of a product", "The difference between the present value of cash inflows and outflows", "Total profit from last year", "Value of a company on the stock market"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A type of bank loan", "The discount rate that makes the NPV of a project zero", "The annual growth rate of a company", "A tax on international trade"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["When a company goes bankrupt", "The point at which total cost and total revenue are equal", "When a company makes its first \$1 million", "Ending a business partnership"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["The cost of starting a business", "The loss of potential gain from other alternatives when one is chosen", "A discount given to customers", "The total cost of production"],
        "ans" => 1,
    ...
    [
        "category" => "startup",
        "q" => "What is 'Sunk Cost'?",
        "opt" => ["A cost that is zero", "A cost that has already been incurred and cannot be recovered", "The cost of building a pool", "Money spent on luxury items"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Measuring the size of a factory", "Cost advantages companies obtain due to their scale of operation", "A type of tax on large businesses", "A law about minimum wages"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Monopoly'?",
        "opt" => ["Many sellers in the market", "A market structure with only one seller", "Two companies dominating the market", "A government-owned bank"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Oligopoly'?",
        "opt" => ["One seller in the market", "A market structure dominated by a small number of large sellers", "No sellers in the market", "A market with infinite sellers"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Total sales of a company", "Revenue minus cost of goods sold (COGS)", "Total money in the bank", "A tax on company profits"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["The size of an office", "A measure of what proportion of revenue is left after paying for variable costs", "Total daily sales", "The speed of production"],
        "ans" => 1,
    ...
    [
        "category" => "startup",
        "q" => "What is 'EBIT'?",
        "opt" => ["Earnings Before Interest and Taxes", "Electronic Bank Income Tool", "Early Business Investment Tool", "Every Business Income Tool"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["The cost of making a product", "Measure of how much the quantity demanded of a good responds to a change in price", "The weight of a product", "The time it takes to sell a product"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Closing down a market", "Dividing a broad target market into subsets of consumers", "Calculating total sales", "Buying shares of different companies"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fighting in a competitive market", "Creating an uncontested market space where competition is irrelevant", "Trading in international waters", "A strategy for shipping companies"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Hiring staff quickly", "Inventory strategy to increase efficiency and decrease waste by receiving goods only as they are needed", "A fast marketing plan", "Ending a meeting on time"],
        "ans" => 1,
    ...
    [
        "category" => "marketing",
        "q" => "What is 'Six Sigma'?",
        "opt" => ["A type of marketing", "A set of techniques for process improvement and quality management", "A group of six companies", "A financial tax bracket"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Setting up benches in office", "Comparing business processes and performance metrics to industry bests", "Calculating employee working hours", "Closing a deal with a client"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Strengths, Weaknesses, Opportunities, Threats", "Sales, Wages, Operations, Taxes", "Strategy, Work, Output, Timing", "Success, Wealth, Optimization, Trust"],
        "ans" => 0,
    ...
    [
        "category" => "daily",
        "q" => "What is 'KPI'?",
        "opt" => ["Key Performance Indicator", "Key Profit Income", "Knowledge Process Integration", "Key Personnel Information"],
        "ans" => 0,
    ...
    [
        "category" => "daily",
        "q" => "What is 'ROI'?",
        "opt" => ["Rate of Interest", "Return on Investment", "Risk of Inflation", "Regular Open Income"],
        "ans" => 1,
    ...
    [
        "category" => "startup",
        "q" => "What is 'B2C'?",
        "opt" => ["Business to Customer", "Bank to Customer", "Business to Company", "Basic To Company"],
        "ans" => 0,
    ...
    [
        "category" => "daily",
        "q" => "What is 'C2C'?",
        "opt" => ["Company to Company", "Customer to Customer", "Customer to Company", "Company to Customer"],
        "ans" => 1,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'Web 3.0'?",
        "opt" => ["The first version of the web", "The decentralized web based on blockchain technology", "A high-speed internet cable", "A type of web browser"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A contract written on paper", "A self-executing contract with terms directly written into code", "A meeting with a lawyer", "A high interest loan"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Formula 1 Winner", "The Masters Golf Tournament Winner", "Wimbledon Winner", "NBA Champion"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Start of the race", "To signal the end of the race", "To signal a car accident", "To signal a pit stop"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Lewis Hamilton", "Max Verstappen", "Sebastian Vettel", "Fernando Alonso"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Wimbledon", "US Open", "Roland Garros (French Open)", "Australian Open"],
        "ans" => 2,
    ...
    [
        ...
        "opt" => ["Trifecta", "Exacta", "Quinella", "Superfecta"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paris", "Monte Carlo", "Nice", "Barcelona"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Leukemia", "Mesothelioma", "Lymphoma", "Melanoma"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Tax Lawyer", "Personal Injury Lawyer", "Corporate Lawyer", "Divorce Lawyer"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Debt-to-Income ratio", "Daily Tax Income", "Digital Trade Interest", "Direct Total Investment"],
        "ans" => 0,
        "exp" => "DTI is used by lenders to determine a borrower's ability to manage monthly payments."
    ],
    [
        ...
        "opt" => ["Annual Percentage Rate", "Average Price Ratio", "Annual Payment Return", "Actual Profit Rate"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Cloud Computing", "Blockchain", "Artificial Intelligence", "Metaverse"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["System as a Service", "Software as a Service", "Secure Apple System", "Standardized Asset Software"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for old cars", "Covers the difference between car value and loan balance", "Insurance for tires", "A discount for new drivers"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["The total payout", "The amount you pay out-of-pocket before insurance pays", "A discount on price", "The monthly fee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Social media posting", "Improving website visibility on Google", "Sending emails", "Designing logos"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A mythological animal", "A private company valued at over \$1 billion", "A company with 1 employee", "A business that sells toys"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["120 miles", "140 miles", "150 miles", "180 miles"],
        "ans" => 2,
    ...
    [
        ...
        "opt" => ["1 point", "2 points", "3 points", "4 points"],
        "ans" => 2,
    ...
    [
        ...
        "opt" => ["Germany", "Argentina", "Brazil", "Italy"],
        "ans" => 2,
    ...
    [
        ...
        "opt" => ["21.1 km", "42.195 km", "10 km", "50 km"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Triple Play", "Hat-trick", "Grand Slam", "Strike"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Intentional harm", "Failure to take proper care, resulting in damage to others", "Winning a case", "Paying a fine"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A person who sells policies", "A professional who investigates claims to determine payout", "A car mechanic", "A lawyer"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Death from natural causes", "A claim against a person who can be held liable for a death", "A type of insurance", "A funeral plan"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Interest changes every month", "Interest rate remains the same throughout the loan term", "A loan with zero interest", "A loan for cars only"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Spending more money", "Combining multiple debts into a single, lower-interest payment", "Filing for bankruptcy", "Closing a bank account"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Long Term Value", "Loan-to-Value ratio", "Low Total Variable", "Large Tax Verification"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying a new card", "A service that helps remove inaccurate info from credit reports", "Increasing your salary", "A bank for students"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A type of ball", "A 7.5 minute period of play", "The winning trophy", "A penalty shot"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["The Open", "The Masters", "US Open", "PGA Championship"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Driver Rescue System", "Drag Reduction System", "Digital Race Start", "Direct Road Steering"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Winning 100 matches", "Winning all 4 major tournaments in a single year", "A 5-set match", "Winning a gold medal"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["The number of players", "The numerical expression of winning probability and payout", "The ticket price", "The duration of the game"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Counting money", "The process of analyzing raw data to find trends and insights", "Writing code for games", "Selling computers"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["The death benefit only", "The savings portion of a permanent life policy", "The monthly cost", "The bank balance"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for old cars", "Covers the difference between car value and loan balance if totaled", "Insurance for tires", "A discount for new drivers"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Covers your injuries", "Covers damage and injury you cause to others", "Covers theft", "Insurance for your garage"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Health Maintenance Organization", "High Medical Option", "Hospital Management Order", "Home Medical Office"],
        "ans" => 0,
    ...
    [
        "category" => "finance",
        "q" => "What is an 'IPO'?",
        "opt" => ["Internal Profit Order", "Initial Public Offering", "International Price Option", "Instant Purchase Order"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A bank employee", "A person legally bound to act in another's best interest", "A high credit score", "A tax lawyer"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Changing targets", "Showing ads to people who already visited your site", "New marketing"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Legal ownership", "Score predicting how well a site will rank", "Server speed"],
        "ans" => 1,
    ...
    [
        "category" => "gk",
        "q" => "What is 'Upwork'?",
        "opt" => ["Social media", "Leading global freelance marketplace", "Streaming site"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Annual Percentage Rate", "Annual Payment Return", "Auto Price Rate"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Running speed", "Creditworthiness", "Social status"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Personal health", "Protection against injury to public", "Government insurance"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Maximum for food", "Cap on daily hospital room charges", "Hotel stay"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Dark Web'?",
        "opt" => ["Internet at night", "Hidden part of internet for illegal acts", "Private browsing"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fast PC", "Computing using quantum mechanics for complex math", "Old tech"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Type of car", "Asset used to secure a loan", "Monthly payment"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A goal", "A rule violation", "A type of kick"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Image title", "Description of image for search engines and accessibility", "Image filter"],
        "ans" => 1,
    ...
    [
        "category" => "insurance",
        "q" => "What is 'Upselling'?",
        "opt" => ["Selling for less", "Encouraging customers to buy a premium version", "Giving free gifts"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["News report", "Mathematical tool for price charts", "Bank statement"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Algorithm'?",
        "opt" => ["Math book", "Step-by-step instructions for a computer", "Music beat"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Manchester City", "Real Madrid", "Liverpool"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Sending emails", "Tracking website traffic and behavior", "Building websites"],
        "ans" => 1,
    ...
    [
        "category" => "marketing",
        "q" => "What is 'AdSense'?",
        "opt" => ["Google's program for publishers to show ads", "An ad agency", "Keyword tool"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["A fruit seed", "Smallest price move in a currency", "Trading account"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Asking for money", "Check of your credit report by lenders", "Bank interview"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Company closing down", "Dividing existing shares into more shares", "Selling shares"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Time to buy", "Extra time to pay premium after due date", "Time for claim"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Malware'?",
        "opt" => ["Good software", "Malicious software (viruses, etc.)", "Fast hardware"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Moving to bank", "Moving debt from a high-interest card to a low-interest one", "Cashback"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'FDI'?",
        "opt" => ["Federal Deposit", "Foreign Direct Investment", "Fast Digital Income"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Messi", "Jose Mourinho", "Pep Guardiola"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying before buying", "Paying back loan earlier than scheduled", "Late fee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Holding for hours", "Holding for days or weeks", "Trading in playground"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["European Cup", "South American club championship", "Youth cup"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'OpenAI'?",
        "opt" => ["A browser", "An AI research and deployment company", "A hardware store"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Naming a site", "Showing unique content to each user", "Hiding data"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A cricket game", "Top football tournament in Asia", "A business group"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Saving money", "Process of paying off debt in regular parts", "Selling property"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Account with real money", "Practice account with virtual money", "Bank account for kids"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["David Beckham", "Pele", "Maradona"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Ronaldinho", "Zinedine Zidane", "Zlatan"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling to competitors", "Suggesting related or complementary products", "Cancelling a sale"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["House builder", "Professional who helps buy/sell property", "Banker"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Total salary before tax", "Take-home pay after tax/deductions", "Monthly rent"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["High speed", "Hackers can easily steal your data", "Low battery"],
        "ans" => 1,
    ...
    [
        "category" => "startup",
        "q" => "What is 'FBA'?",
        "opt" => ["Federal Bank account", "Fulfillment by Amazon", "Fast Business Ads"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Gaming in rain", "Playing high-end games via internet without console", "Mobile games"],
        "ans" => 1,
    ...
    [
        "category" => "gk",
        "q" => "What is 'BRICS'?",
        "opt" => ["Building material", "Group of emerging economies (Brazil, Russia, India, China, SA)", "A bank name"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Sunglasses", "Smart glasses with camera and AI", "A movie"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Writing about ghosts", "Writing content for someone else under their name", "Secret diary"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying points", "Using points for travel, shopping, or cashback", "Selling a card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Playing music", "Using Unmanned Aerial Vehicles (Drones)", "Sleeping"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Major League Soccer", "Main Level Sports", "Multi League System"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Bank calling you", "Credit check by a lender when you apply for a card", "Checking score yourself"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Extra interest", "Temporary period where you don't pay EMI", "Loan closure"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Messi", "Cristiano Ronaldo", "Pele"],
        "ans" => 1,
    ...
    [
        "category" => "music",
        "q" => "What is 'Bandwidth'?",
        "opt" => ["Number of bands", "Data transfer capacity", "Music group"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Legal paper", "Self-executing code on blockchain", "Bank agreement"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling many items", "Promoting expensive products with high commissions", "Expensive ads"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A chat robot", "File that tells search engines which pages to crawl", "A virus"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Using two passwords", "Password + Extra code (OTP)", "Logging out"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Smishing'?",
        "opt" => ["Phishing via SMS", "Smiling while phishing", "Selling online"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Fixed prices", "Speed and size of price movements", "Market closing"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Ronaldinho", "Cristiano Ronaldo", "Ronaldo Nazario"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'PCI DSS'?",
        "opt" => ["Security standard for card data", "A type of card", "Bank name"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["One-time fee", "Yearly charge for using the card", "Monthly interest"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Answering calls", "Marketing designed to get an immediate action", "TV news"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Section 80C", "Section 80D", "No benefit"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Old LED", "Organic Light Emitting Diode", "Output LED"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A bank manager", "Firm that provides access to trading platform", "A trader"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Company's total profit", "Dividend per share divided by price", "Stock price growth"],
        "ans" => 1,
    ...
    [
        "category" => "insurance",
        "q" => "What is 'Nominee'?",
        "opt" => ["Insurance company", "Person who receives benefits after death", "The agent"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Creating a website", "Space to store website files", "Internet speed"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Customer discount", "Fee merchants pay to banks for card payments", "Card interest"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Two people trading", "Value of one currency against another", "Bank account"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Free gift", "Recurring delivery of products (e.g. Netflix)", "Cardboard box"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Website color theme", "Google's speed and user experience metrics", "Social media followers"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying premium", "Request for compensation", "Cancelling policy"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Plant name", "List of words to recover a wallet", "Username"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["New policy", "Inactive policy due to non-payment", "Cheap policy"],
        "ans" => 1,
    ...
    [
        "category" => "travel",
        "q" => "What is 'Notion'?",
        "opt" => ["Notebook", "All-in-one workspace for notes, tasks, and wikis", "Drawing app"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Leicester", "Manchester City", "Arsenal"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Illegal device stealing card info at ATMs", "Buying a card", "Card discount"],
        "ans" => 0,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Neuralink'?",
        "opt" => ["New internet", "Brain-computer interface company by Elon Musk", "Social network"],
        "ans" => 1,
    ...
    [
        "category" => "marketing",
        "q" => "What is 'PPC'?",
        "opt" => ["Pay Per Click", "Price Per Customer", "Paper Print Cost"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Stable market", "The degree of price variation over time", "Market closing"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["\$50,000", "\$20 Million", "\$1 Billion"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["End of contract", "Fixed fee to buy a player without negotiation", "A type of injury"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Car insurance", "Protection against errors and omissions", "Life cover"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["MLS", "Saudi Pro League", "Premier League"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying with cash", "Taking a loan to pay large premiums", "Free insurance"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'SQL'?",
        "opt" => ["Simple Query Logic", "Structured Query Language", "Server Quick Link"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Building social apps", "Manipulating people into giving secrets", "Marketing"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Eye glasses", "AI that can understand images/videos", "Watching TV"],
        "ans" => 1,
    ...
    [
        "category" => "insurance",
        "q" => "What is 'Exclusion'?",
        "opt" => ["Things covered", "Things NOT covered by policy", "The premium"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Biology test", "Security using physical traits like Fingerprint/Face ID", "Life history"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Money from your job", "Money earned with little to no daily effort", "A gift"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Holding only cash", "Holding various types of investments", "Holding one stock"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["New color", "Moving to a higher tier card with better benefits", "Cancelling card"],
        "ans" => 1,
    ...
    [
        "category" => "travel",
        "q" => "What is 'Burnout'?",
        "opt" => ["Fire", "Physical or mental exhaustion from overwork", "Cooking"],
        "ans" => 1,
    ...
    [
        "category" => "realestate",
        "q" => "What is 'Zoning'?",
        "opt" => ["Sleeping area", "Laws regulating how land can be used", "Parking area"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fake card", "Card tied to a specific brand (e.g., Air India, Amazon)", "Government card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Citizenship", "Digital identity for non-residents to run EU business", "Passport"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paid cover", "Free travel or air accident insurance with card", "Health cover"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Printing books", "Selling digital books online (e.g. Amazon KDP)", "Library"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Mega commerce", "Mobile commerce", "Mail commerce"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Spyware'?",
        "opt" => ["Camera app", "Software that secretly records your activity", "GPS"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["5 Gigabytes", "5th Generation mobile network", "Google 5"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Interest changes every year", "Interest rate stays same for entire loan", "No interest"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying loan fast", "Lender pays homeowner monthly income", "Selling house"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Working at home", "Shared office for freelancers and remote workers", "Company office"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying with cash", "Insurer pays hospital directly", "Free hospital"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Trading for many years", "Buying with expectation price will rise", "Selling fast"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Free app", "Malware that locks data for money", "Antivirus"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Reverse gear", "Copy of website data to prevent loss", "Deleting files"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A space star", "Award for high-quality restaurants", "Tire quality"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Company making caps", "Company with small market value", "Government bank"],
        "ans" => 1,
    ...
    [
        "category" => "gk",
        "q" => "What is 'UGC'?",
        "opt" => ["User Generated Content (Reviews, Photos)", "Universal Global Code", "Under Ground Club"],
        "ans" => 0,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'Rug Pull'?",
        "opt" => ["Cleaning a rug", "Scam where developers abandon project", "Price jump"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A private bank", "Central Bank of the United States", "A tax agency"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Backing up data", "Unauthorized leakage of private data", "Internet crash"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["3-digit code for online transactions", "Bank's address", "Card's name"],
        "ans" => 0,
    ...
    [
        "category" => "space",
        "q" => "What is 'Starlink'?",
        "opt" => ["Movie", "Satellite internet service for remote areas", "Telescope"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Personal ID", "Internet Protocol Address", "Postal code"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["School game", "FIFA tournament for youth players", "Local cup"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Market closing", "Sudden and dramatic decline in stock prices", "Buying many stocks"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Liverpool", "Manchester United", "AC Milan"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Speed", "One million pixels; measure of image resolution", "Memory"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["New company", "Large, stable, reliable company", "Loss-making company"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Satoshi Nakamoto", "Vitalik Buterin", "Elon Musk"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Attack on Day 0", "Attack using a vulnerability the maker doesn't know", "Failed attack"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is '2FA'?",
        "opt" => ["Using 2 cards", "Two-Factor Authentication (OTP + Password)", "Double payment"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Messi", "Cristiano Ronaldo", "LeBron James"],
        "ans" => 1,
    ...
    [
        "category" => "auto",
        "q" => "What is 'SERP'?",
        "opt" => ["Search Engine Results Page", "Social Engine Report", "Secure Engine Record"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Only design expert", "Developer who handles both frontend and backend", "Mobile expert"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Determination to do work", "Document for asset distribution after death", "A bank form"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fear of Missing Out", "Fast Only Money Offer", "Focus On Market Only"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Low exports", "When a country imports more than it exports", "No trade"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A bank", "Stock market regulator", "Investment company"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bank account number", "Secret code to access crypto", "Email password"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Full day stay", "Treatment requiring less than 24h stay", "Only medicine buy"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Know Your Customer", "Keep Your Cash", "Know Your Company"],
        "ans" => 0,
    ...
    [
        "category" => "realestate",
        "q" => "What is 'Lot Size'?",
        "opt" => ["Size of a house", "Number of currency units traded", "Broker's office"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Breaking a card", "Opening/Closing cards to get multiple sign-up bonuses", "Using one card only"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Music chip", "Security chip for transactions", "Tracking chip"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Big house", "Home with devices connected to the internet", "School"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bank for everyone", "International organization providing loans for development", "A crypto bank"],
        "ans" => 1,
    ...
    [
        "category" => "auto",
        "q" => "What is 'WordPress'?",
        "opt" => ["A type of browser", "A popular Content Management System (CMS)", "A search engine"],
        "ans" => 1,
    ...
    [
        "category" => "sports",
        "q" => "What is 'Docker'?",
        "opt" => ["Ship worker", "Tool for running apps in containers", "A file type"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bank for money", "Portable battery to charge devices", "Electricity house"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Distance of flight", "Points earned on travel cards to get free flights", "Speed of plane"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A magnet toy", "Free value given in exchange for an email", "A heavy lead"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Seiko", "Patek Philippe", "Casio"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A player", "Real Madrid's stadium", "A tournament"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is '404 Error'?",
        "opt" => ["Page found", "Page not found", "Server down"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling everything", "Targeting a specific, small segment", "TV ads"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Same as credit card", "Must pay full balance every month", "Prepaid card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Changing staff", "How many times a company sells and replaces its stock", "Moving a warehouse"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Printing documents", "Adding interactivity to websites", "Creating logos"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Term insurance", "Savings + Insurance", "Health cover"],
        "ans" => 1,
    ...
    [
        "category" => "math",
        "q" => "What is 'Logistics'?",
        "opt" => ["Math problem", "Managing flow and storage of goods", "Writing blogs"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Building a house", "Staying in a home for free while owners are away", "Cleaning"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Airport runway", "Webpage designed for a specific goal", "Homepage"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Opening account", "Paying full loan before tenure ends", "Borrowing more"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Current market price", "Original value of a share", "Company's reputation"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Empty box", "Generic product sold under your brand", "Medical product"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Single stock", "Pool of money from investors", "Government scheme"],
        "ans" => 1,
    ...
    [
        "category" => "geo",
        "q" => "What is 'Leverage'?",
        "opt" => ["Free money", "Borrowing funds to increase trade size", "A type of tax"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Earnings Per Click", "Every Person Clicks", "Electronic Payment Code"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["A holiday", "Major shopping day with high discounts", "Friday the 13th"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Interest", "One-time charge for loan application", "Fine"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Prada", "Christian Louboutin", "Jimmy Choo"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Social media", "International money transfers and payments", "Photography"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fever cover", "Cover for life-threatening diseases", "Accident cover"],
        "ans" => 1,
    ...
    [
        "category" => "realestate",
        "q" => "What is 'Lien'?",
        "opt" => ["A type of floor", "Legal claim on property for debt", "Property discount"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Long term trading", "Making many small profits in seconds", "Losing money"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Cheap wine", "Wine made from grapes of a specific high-quality year", "Old bottle"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Van Life'?",
        "opt" => ["Living in a van while traveling", "Driving a van for work", "Selling vans"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Virgil van Dijk", "Harry Maguire", "Josko Gvardiol"],
        "ans" => 2,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Chatbot'?",
        "opt" => ["A human chatter", "AI program designed to simulate conversation", "A game"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Stock that pays dividends", "Stock expected to grow faster than market", "Old company"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Number of agents", "% of claims a company has paid", "Company's profit"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'SKU'?",
        "opt" => ["Stock Keeping Unit", "Simple Key Unit", "Store Kind Unit"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Bank's door", "Service that processes credit card payments online", "A shipping tool"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'RevShare'?",
        "opt" => ["Sharing news", "Percentage of revenue shared with the affiliate", "Free sharing"],
        "ans" => 1,
    ...
    [
        "category" => "fashion",
        "q" => "What is 'Big Data'?",
        "opt" => ["Large hard drive", "Massive and complex datasets", "Internet speed"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Penny stock", "Stock of large, reliable, and profitable company", "New startup"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Security guard", "Personal assistant service provided by premium cards", "Cleaning service"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Reward points", "High fee for withdrawing cash from ATM using credit card", "Interest"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Silence", "Technology to block out background sound", "Quiet room"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fake human", "Machines mimicking intelligence", "Fast computer"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Savings with fixed term", "Stock trading", "Crypto coin"],
        "ans" => 0,
    ...
    [
        "category" => "sports",
        "q" => "What is 'Yachting'?",
        "opt" => ["Fishing", "Traveling or racing on luxury boats", "Swimming"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Everton", "Liverpool", "Man City"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Ball speed", "Percentage of users who leave after 1 page", "Upload speed"],
        "ans" => 1,
    ...
    [
        "category" => "gaming",
        "q" => "What is 'Euro 2024'?",
        "opt" => ["Asian cup", "European National Championship", "Club game"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Juventus", "AC Milan & Inter Milan", "Roma"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Old Trafford", "Wembley", "Anfield"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Loan", "Points used to pay off part of your card bill", "A receipt"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'CVV'?",
        "opt" => ["Card Valet Value", "Card Verification Value", "Common Visual Value"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["VIP entrance", "Global membership program for airport lounges", "A visa"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Talking on phone", "Messaging without expecting immediate reply", "Group meeting"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Lightning", "High-speed hardware interface by Intel/Apple", "Battery port"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["New loan", "Extra loan over an existing loan", "Phone recharge"],
        "ans" => 1,
    ...
    [
        "category" => "fashion",
        "q" => "What is a 'Niche'?",
        "opt" => ["A large market", "A specific, focused segment of a market", "A brand name"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Uptime'?",
        "opt" => ["Time to sleep", "Percentage of time a server is running", "Upload speed"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Database management", "The part of website users see and interact with", "Server coding"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Spending vs Salary", "Balance vs Credit Limit", "Tax vs Income"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A power cable", "Software to add new features to a site", "A virus"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Max cash in bank", "Max money you can spend on credit card", "Minimum balance"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Large resort", "Small, stylish, and unique luxury hotel", "Cheap motel"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Singer", "Individual who runs their business alone", "Solar worker"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Ship engine cover", "Insurance for goods in transit by sea/air", "Beach cover"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bank holiday", "The monthly period between two bill generations", "Payment due date"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Speed of money", "Value of one currency compared to another", "Bank interest"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'API'?",
        "opt" => ["Application Programming Interface", "Apple Price Info", "Auto Program Ink"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Haaland", "Lionel Messi", "Mbappe"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Covers death", "Covers income loss due to injury", "Car cover"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A link you can't click", "Link that doesn't pass SEO authority (link juice)", "Social media link"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Low inflation", "Extremely rapid and out-of-control inflation", "Good economy"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'SSD'?",
        "opt" => ["Solid State Drive", "System Storage Disk", "Slow Speed Drive"],
        "ans" => 0,
    ...
    [
        "category" => "realestate",
        "q" => "What is 'REIT'?",
        "opt" => ["Real Estate Investment Trust", "Retail Income Tool", "Real Estate Info"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Robot", "Tool to install apps like WordPress in 1-click", "Antivirus"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Physical wall", "Network security filter", "Software update"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["List of friends", "Collection of emails from potential customers", "A phone book"],
        "ans" => 1,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'DEX'?",
        "opt" => ["Digital Exchange", "Decentralized Exchange", "Daily Exchange"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'Nifty'?",
        "opt" => ["BSE Index", "NSE Index", "US Market"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Short popular words", "Specific phrases with lower search volume but higher conversion", "Dictionary words"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Losing ID", "Stealing personal info for financial fraud", "A movie name"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Computer hacker", "Someone who works remotely while traveling", "IT worker"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Borrowing from bank", "Lending money directly to others via apps", "Giving money to friends"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Game", "Digital banks for low-cost international transfers", "Cloud storage"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["AI dreaming", "AI generating false or nonsensical info", "AI crashing"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Cartier", "Tiffany & Co.", "Bulgari"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Bear Trap'?",
        "opt" => ["Trap for animals", "False signal of price drop", "Market crash"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Game of 90 mins", "Tie-breaker with 5 kicks", "A free kick"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying a phone", "Google using mobile version of site for ranking", "Faster mobile apps"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'HTTPS'?",
        "opt" => ["Fast website", "Secure website with SSL certificate", "A new browser"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["For vacation", "For starting or expanding a company", "For buying a car"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'Default'?",
        "opt" => ["Normal state", "Failure to repay a loan", "Fast payment"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Free service", "Amount you pay before insurer pays", "Tax discount"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Oil and Water", "Cash or assets easily turned to cash", "A big house"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fixing a house", "Refilling sum insured if used up", "New policy"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Death payout", "Amount paid if you cancel policy early", "Fine for late payment"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Software update", "Overwhelming a server with fake traffic", "Deleting files"],
        "ans" => 1,
    ...
    [
        "category" => "gk",
        "q" => "What is 'Metaverse'?",
        "opt" => ["A new planet", "A shared 3D virtual world", "Social media site"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A new FIFA cup", "A breakaway league for top clubs", "A youth league"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["AC Milan", "Real Madrid", "Liverpool"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Saying hello", "Large points given for meeting spend in first 90 days", "Free card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Online only", "Tapping card on terminal to pay without PIN", "Paying via call"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Safe SEO practices", "Unethical techniques to trick search engines", "SEO for fashion sites"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Keylogger'?",
        "opt" => ["Software that records keystrokes", "Keyboard driver", "A lock"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Time for surgery", "Added minutes at the end of a half", "Half time break"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A music beat", "Set of rules to solve a problem", "Math textbook"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Physical coins", "Stable, globally accepted currency (e.g. USD)", "Fake money"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Cost of stamps", "Tax on legal documents for property", "Postal tax"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying at any price", "Order to buy/sell at a specific price", "Minimum investment"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Extra salary", "Free additional shares to shareholders", "Cash gift"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'VPN'?",
        "opt" => ["Virtual Private Network", "Very Private Node", "Visual Public Net"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["LLM (Large Language Model)", "Video Engine", "Simple Search"],
        "ans" => 0,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Cache'?",
        "opt" => ["Physical cash", "Temporary storage for faster loading", "A virus"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["People with jobs", "% of labor force that is jobless and seeking work", "People retired"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Messi", "Cristiano Ronaldo", "Neymar"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Wallet kept in fridge", "Offline storage for crypto", "Empty wallet"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Profit from long investment", "Profit from assets held for less than a year", "Salary"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Investing a large lump sum", "Investing a fixed amount regularly", "A bank loan"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fake coin", "Any coin other than Bitcoin", "A stable coin"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Ads in local language", "Ads that match the look and feel of the website", "TV ads"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Deflation'?",
        "opt" => ["Falling prices", "Rising prices", "Stable market"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Holiday list", "Schedule of major news and data releases", "Bank calendar"],
        "ans" => 1,
    ...
    [
        "category" => "gk",
        "q" => "What is 'OPEC'?",
        "opt" => ["Ocean pollution", "Organization of Petroleum Exporting Countries", "Energy company"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Shopify/BigCommerce", "Physical shop", "Selling software"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Watching videos", "Team communication and collaboration", "Coding"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Car repair", "Covers death or disability due to accident", "Medical checkup"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Prices are falling", "Prices are rising", "Market is closed"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Two policies", "Twice the benefit for accidental death", "Fake insurance"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'CTA'?",
        "opt" => ["Call to Action", "Customer To Agent", "Click To Apply"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Life cover only", "Lump sum payout for serious diseases", "Hospital bill only"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Website design", "Code that helps search engines provide rich snippets", "A type of database"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Vishing'?",
        "opt" => ["Phishing via phone calls", "Phishing via video", "Fake emails"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Buying expensive stocks", "Buying undervalued stocks", "Following tips"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paid traffic", "Free traffic from search engine results", "Traffic from friends"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A picture frame", "A pre-written library for faster development", "A computer"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A gaming console", "Free tool to monitor site performance in Google", "Paid ad tool"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Extra premium", "Discount for claim-free year", "A penalty"],
        "ans" => 1,
    ...
    [
        "category" => "marketing",
        "q" => "What is 'CTR'?",
        "opt" => ["Click Through Rate", "Customer Total Return", "Cash Transfer Rate"],
        "ans" => 0,
    ...
    [
        "category" => "daily",
        "q" => "What is 'HTTP'?",
        "opt" => ["Hyperlink Text Protocol", "Hypertext Transfer Protocol", "High Tech Transfer"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Physical wallet", "App for storing money and paying (GPay)", "Crypto key"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Original money borrowed", "Total interest paid", "Bank's profit"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Launching it", "Gradually stopping production", "Increasing price"],
        "ans" => 1,
    ...
    [
        "category" => "retirement",
        "q" => "What is 'Annuity'?",
        "opt" => ["One-time payment", "Regular income for retirement", "Yearly tax"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Only sender/receiver can read data", "Government can read", "Public data"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Time to bake", "How long an affiliate link stays active for a user", "Storage size"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Messi", "Cristiano Ronaldo", "Lewandowski"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Traffic light", "Trading suggestion from a pro/software", "Mobile network"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Getting change", "Bank returns money to buyer after dispute", "Paying extra"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Typing test", "Ethical hacking to find weaknesses", "New software"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A game", "Malware disguised as useful software", "Fast CPU"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Computer Main System", "Content Management System", "Cloud Main Server"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Debugging'?",
        "opt" => ["Killing insects", "Finding and fixing errors in code", "Cleaning computer"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Donating to charity", "Selling products directly through social media", "Meeting friends"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying contract", "Rental contract", "Tax paper"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'AOV'?",
        "opt" => ["Average Order Value", "Auto Online View", "All Out Venture"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Simple test", "Testing two site versions for better sales", "Grading products"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fixed price", "Changing prices based on demand and data", "Discount code"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Dashboard to manage hosting", "TV remote", "Keyboard"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Full virtual world", "Digital overlays on real world", "3D movies"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Time to buy", "Extra time to pay premium after due date", "Gift time"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["The insurance company", "The owner of the policy", "The agent"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Using many keywords naturally", "Repeating keywords excessively to manipulate rankings", "Writing long articles"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Life cover", "Medical expense cover", "Travel cover"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A blank page", "Document explaining a crypto project", "A tax form"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for aliens", "Flexible premium life insurance", "Fixed price cover"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Human seller", "AI assistant for customer queries", "Phone call"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Linking to other websites", "Linking from one page to another on the same site", "Social media links"],
        "ans" => 1,
    ...
    [
        "category" => "gadgets",
        "q" => "What is 'USB-C'?",
        "opt" => ["Slow charger", "Universal connector for power and data", "Apple cable only"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A sea animal", "Investor with huge amount of crypto", "A scammer"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Best young player", "Best female football player award", "A French club"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Death benefit", "Amount received at end of policy term", "Monthly pension"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Award for best goalie", "Award for top goalscorer", "Golden shoes"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Old bug", "A flaw unknown to the software maker", "Fixed bug"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Total premium", "Maximum amount insurer will pay", "Tax amount"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["New card", "Secondary card for family members on same account", "Prepaid card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Deep pool", "Pool that appears to merge into the horizon/ocean", "Small pool"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Inviting guests home", "Writing an article for another website to get a link", "Posting on Facebook"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for car", "Protection against property ownership disputes", "Life insurance"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Only sender/receiver can read", "Server can read", "Public chat"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Liverpool", "Manchester United", "Chelsea"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'Mortgage'?",
        "opt" => ["Car loan", "Loan for property/house", "Business loan"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Liquidity'?",
        "opt" => ["Company's debt", "Ease of converting asset to cash", "Oil price"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["User Interaction", "User Interface", "Universal Image"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying rent", "Money earned from leasing a property", "Selling a house"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bank closing", "Bank buying/selling currency to stabilize it", "Giving free loans"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Lamborghini", "Ferrari", "Porsche"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Coin that never grows", "Coin pegged to a stable asset like USD", "Oldest coin"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Asian tournament", "European club competition", "World Cup"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Currency tied to gold/oil", "A physical coin", "Digital money"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Height vs Weight", "Your debt vs your gross income", "Tax vs Salary"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["\$10 Million", "\$42 Million", "\$100 Million"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["9 months", "Typically 2 to 4 years", "No waiting"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Government control", "Economic system where private owners control trade and industry", "Sharing everything"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Car repair", "Payout for death or disability by accident", "Health checkup"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for a boat", "One sum insured for the whole family", "Travel insurance"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Brain surgery", "Computing system inspired by biological brains", "Internet cable"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["User Experience", "User X-ray", "Universal Exchange"],
        "ans" => 0,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'ICO'?",
        "opt" => ["Initial Coin Offering", "Internal Coin Office", "Instant Cash Only"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["One-time purchase", "Recurring payment for regular product delivery", "Free trial"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Shared hosting", "Virtual Private Server", "Physical server only"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Checking company's office", "Using charts and patterns to trade", "Reading news only"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Moving bags", "Borrowing low-interest currency to invest in high-interest one", "Exchange cash"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["European tournament", "South American national team championship", "Asian cup"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["First day at office", "Company designed to function without physical office", "Startup"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fixed loan", "Credit that renews as you pay back", "One-time use"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fast loading", "Process of increasing % of visitors who buy", "Design change"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'FTP'?",
        "opt" => ["File Transfer Protocol", "Fast Tech Pro", "File Total Price"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["NBA", "Premier League", "La Liga"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'Inventory'?",
        "opt" => ["A list", "Stock of goods on hand", "Profit"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Price to Earnings", "Profit to Expense", "Price to Equity"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Game score", "Number showing your loan repayment history", "Exam marks"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Tax on food", "Tax paid by owners on their real estate", "Sales tax"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Finding long words", "Finding terms people type in Google", "Coding"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Increases value", "Decreases purchasing power", "No effect"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for agents", "Insurance for insurance companies", "Cancelling insurance"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Included items", "Things that are NOT covered", "New features"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Manual payment", "Automatic payment from bank account", "Cash payment"],
        "ans" => 1,
    ...
    [
        "category" => "math",
        "q" => "What is 'G20'?",
        "opt" => ["Group of 20 gamers", "Forum for governments from 20 major economies", "A math formula"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A virus", "Software to detect and delete malware", "New hardware"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Empty packaging", "Buying generic products and selling under your brand", "Doctor's medicine"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Speed of CPU", "Amount of data transferred", "Server location"],
        "ans" => 1,
    ...
    [
        "category" => "investing",
        "q" => "What is 'ETF'?",
        "opt" => ["Easy Trade Fund", "Exchange Traded Fund", "Electronic Transfer Fund"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paid software", "Software whose source code is free to everyone", "Secret code"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fast car", "Self-driving car", "Electric car"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A smaller offer", "Person who joins an affiliate program through you", "A fake link"],
        "ans" => 1,
    ...
    [
        "category" => "gadgets",
        "q" => "What is 'NFC'?",
        "opt" => ["Near Field Communication", "New Fast Chip", "Net File Connection"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Tree roots", "Full administrative control over a server", "Basic user"],
        "ans" => 1,
    ...
    [
        "category" => "sports",
        "q" => "What is 'FIFA'?",
        "opt" => ["Football in France", "International Football Federation", "Fast Football App"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying cash at hospital", "Insurance pays hospital directly", "Free treatment for everyone"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Password", "Fingerprint or Face ID", "Voice call"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["World Cup", "Spanish knockout cup", "Beach soccer"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Call from a friend", "Broker's demand for more funds", "Closing a bank"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Disease after policy starts", "Disease you have before buying policy", "A rare disease"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for rain", "Extra liability cover above other policies", "Car insurance"],
        "ans" => 1,
    ...
    [
        "category" => "insurance",
        "q" => "What is 'TPA'?",
        "opt" => ["Third Party Administrator", "Total Policy Amount", "Tax Paying Agent"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Changing money", "When a visitor completes a desired goal (purchase/signup)", "Switching browser"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Cost of building", "Fees paid at the end of a home sale", "Cost of locks"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["City Football Group", "Glazer Family", "Fenway Sports"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Emptying cart", "Adding items but not finishing purchase", "Lost cart"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fast AI", "Unfair outcomes caused by biased data", "AI error"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying new policy", "Restoring a cancelled/lapsed policy", "Changing nominee"],
        "ans" => 1,
    ...
    [
        "category" => "math",
        "q" => "What is 'Actuary'?",
        "opt" => ["Sales person", "Professional who calculates risks", "Bank manager"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying fee", "Condition (like spending 2L) to not pay yearly fee", "Cancelling card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Investing in one stock", "Investing in different assets", "Saving in cash"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Investing for 10 years", "Buying and selling on the same day", "Trading only at night"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Person to Person", "Price to Profit", "Post to Post"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Flight ticket", "Covers losses during travel", "Car insurance"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Real Madrid", "FC Barcelona", "Bayern Munich"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Norwegian striker", "German coach", "Brazilian goalie"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Latent Semantic Indexing (Related keywords)", "Large Scale Internet", "Local Search Index"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Cold calling", "Attracting customers via quality content", "Outdoor ads"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Sharing a card", "Airlines/Hotels where you can move your card points", "Bank staff"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying taxes", "Illegally not paying taxes", "Tax planning"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'DNS'?",
        "opt" => ["Digital Name System", "Domain Name System", "Data Net Service"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Tax on salary", "Tax on profit from selling an asset", "Tax on shopping"],
        "ans" => 1,
    ...
    [
        "category" => "music",
        "q" => "What is 'EMV Chip'?",
        "opt" => ["Music chip", "The small security chip on the front of the card", "A tracker"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'CAPTCHA'?",
        "opt" => ["Camera name", "Test to tell humans from bots", "File type"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Changes every month", "Stays same for entire loan term", "Zero interest"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling coins", "Locking coins to support network and earn rewards", "Mining"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Debit Card", "Credit Card", "Gift Card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance agent", "Additional benefit to policy", "The insured person"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["One-time payment", "Regular income for life", "Death benefit"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling on one site", "Unified experience across web, app, and physical store", "Selling on TV only"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Calendar year", "12-month period for financial reporting", "Summer time"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying a plane", "Renting an entire airplane for private use", "Economy flight"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Interest rate", "Legal right to insure something/someone", "Bank profit"],
        "ans" => 1,
    ...
    [
        "category" => "realestate",
        "q" => "What is 'Penthouse'?",
        "opt" => ["Small room", "Luxury apartment on the top floor of a building", "A garden"],
        "ans" => 1,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'Airdrop'?",
        "opt" => ["Dropping from plane", "Receiving free crypto tokens", "Fast internet"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'AI PC'?",
        "opt" => ["Fast computer", "Computer with a dedicated chip for AI tasks", "Internet cafe"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Flying car", "Advanced driver assistance system (Tesla)", "Automatic gear"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Discount", "Amount you pay before company starts paying", "Tax benefit"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["ATM fee", "Fee for spending in another currency", "Passport fee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Website's code", "Website's address (e.g., .com)", "Web server"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bank only card", "Card tied to a brand (e.g., Amazon)", "Company ID"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Closing a door", "Lender taking property due to unpaid debt", "Renovating a home"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["No interest forever", "Time between purchase and bill due date", "Gift period"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Best Scorer", "Best Goalkeeper", "Best Defender"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Driving test", "Test of a machine's ability to exhibit intelligent behavior", "Math test"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["AC Milan vs Inter", "Real Madrid vs Barcelona", "Liverpool vs Man Utd"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Deleting data", "Scrambling data to keep it secret", "Printing data"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Jam on bread", "Difference between Buy and Sell price", "Broker fee only"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Covers own damage", "Covers damage to others", "Life cover"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling online", "Optimizing product pages for Google", "Social Media"],
        "ans" => 1,
    ...
    [
        "category" => "realestate",
        "q" => "What is 'Appraisal'?",
        "opt" => ["A promotion", "Professional estimate of property value", "Cleaning"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Stock price", "How easily a stock can be sold", "Company's cash"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Free petrol", "Getting back the 1% fee on fuel purchases", "Discount on car"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Gardening", "Updating software to fix security holes", "Writing code"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["La Liga", "Premier League", "Serie A"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Marketing for medicine", "Content that spreads rapidly online", "Secret marketing"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["For students", "For business expenses and taxes", "Personal card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Gucci", "Hermès", "Louis Vuitton"],
        "ans" => 1,
    ...
    [
        "category" => "gaming",
        "q" => "What is 'VAR'?",
        "opt" => ["Very Awesome Ref", "Video Assistant Referee", "Voice Audio Ref"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Single brand shop", "Site where many sellers sell (e.g. eBay)", "Offline mall"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Total words", "Percentage of times a keyword appears in content", "Keyword length"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Any two currencies", "Pairs involving the US Dollar", "Crypto pairs"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Standard tourist visa", "Visa allowing long-term stay for remote workers", "Work permit"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["European Cup", "South American Cup", "African Cup"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Long term", "Trading within the same day", "Monthly trading"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'CIBIL'?",
        "opt" => ["A bank", "Credit Information Bureau (India) Ltd", "A loan type"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'MSME Loan'?",
        "opt" => ["Mega Scale", "Micro, Small and Medium Enterprises", "Mostly Small"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Rate of Interest", "Return on Investment", "Risk on Income"],
        "ans" => 1,
        "exp" => "ROI measures the gain or loss generated on an investment relative to its cost."
    ],
    [
    ...
    [
        ...
        "opt" => ["Maradona", "Pelé", "Ronaldo Nazario"],
        "ans" => 1,
    ...
    [
        "category" => "marketing",
        "q" => "What is 'SMM'?",
        "opt" => ["Social Media Marketing", "Simple Mail Maker", "Social Money Manager"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Hosting for any site", "Optimized hosting for WordPress sites", "Free hosting"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Second currency in pair", "First currency in a pair", "National currency"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling same product twice", "Showing ads to previous visitors", "Changing brand name"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["First day of season", "Last day to buy/sell players", "Holiday"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Cost Per Action", "Cost Per Ad", "Cash Plus Account"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Saving money", "Central bank injecting money into the economy", "High taxes"],
        "ans" => 1,
    ...
    [
        "category" => "fashion",
        "q" => "What is '401(k)'?",
        "opt" => ["A tax code", "US retirement savings plan", "A car model"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying fans", "Partnering with social media personalities to promote brands", "Political ads"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Card that gives cash", "Card that returns a % of spending", "Free card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Omega", "Rolex", "Patek Philippe"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Broken camera", "Tiredness from excessive video calls", "Slow internet"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Internet in rain", "Saving data on remote servers (e.g. Dropbox)", "USB drive"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Covers common cold", "Lump sum for major diseases like Cancer", "Covers eye checkups"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Shipping from plane", "Selling items without holding stock", "Fast delivery"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Profit growth", "% of customers who stop using your service", "Speed of site"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Residential houses", "Properties used for business/offices", "Farms"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bank manager", "Person responsible if borrower fails to pay", "Salesman"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Loan for a car", "Loan to pay for education", "Free money"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Single company stock", "Fund that tracks a specific market index (e.g. Nifty 50)", "Bank account"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Cashback", "Increase in sum insured for claim-free year", "Free checkup"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'CPL'?",
        "opt" => ["Cost Per Lead", "Cost Per Link", "Cash Price Low"],
        "ans" => 0,
    ...
    [
        "category" => "tax",
        "q" => "What is 'Tariff'?",
        "opt" => ["Free trade", "Tax on imported goods", "A boat"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Surfing in ocean", "Watching someone enter PIN/password over their shoulder", "A gym exercise"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["King's money", "Payment for use of creative work (books, music)", "Tax"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Latentcy'?",
        "opt" => ["Fast speed", "Delay in data transfer", "Storage size"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Spending more than earned", "Spending on groceries", "Buying a house"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Only death cover", "Life cover + Maturity benefit", "Medical plan"],
        "ans" => 1,
    ...
    [
        "category" => "marketing",
        "q" => "What is 'GitHub'?",
        "opt" => ["Social media for kids", "Platform for version control and code sharing", "A gaming site"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying players", "Selling club jerseys and products", "Match tickets"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Python'?",
        "opt" => ["A snake", "A versatile programming language for AI/Web", "A game"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Visual Reality", "Virtual Reality", "Video Record"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A link to previous page", "Link from another site to your site", "Broken link"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'CDN'?",
        "opt" => ["Content Delivery Network", "Cloud Data Node", "Core Digital Net"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Music", "Project management and organization", "Emailing"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Claim amount", "Amount paid to keep policy active", "Bonus"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fair play on field", "Clubs must not spend more than they earn", "Equal salaries"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'CSS'?",
        "opt" => ["Cascading Style Sheets", "Computer Style System", "Core Site Style"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Fast loading", "Security for encrypted connection", "Website design"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Saving data", "Processing complex math for AI", "Displaying time"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A politician", "Person with large social media following", "A hacker"],
        "ans" => 1,
    ...
    [
        "category" => "geo",
        "q" => "What is 'Sitemap'?",
        "opt" => ["Google Maps", "A list of all pages on a website for search engines", "Physical map"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A partner", "Person earning commission for sales", "A competitor"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying jewelry only", "Holding gold as a hedge against inflation", "Mining gold"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Hyper Text Markup Language", "High Tech Modern Language", "Hyperlink Text Mode"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Server for everyone", "An entire server for one user", "Cloud storage"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Liverpool", "Manchester United", "Arsenal"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Money in bank", "Maximum you can spend on a card", "Card's weight"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Weather forecast", "Visual tool showing where users click on a site", "A hot product"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Covers car", "Covers house and contents", "Covers health"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Winning 3 matches", "Winning League, Domestic Cup, and Champions League", "3 goals in a game"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Ticket price", "Money paid to buy a player", "Referee's salary"],
        "ans" => 1,
    ...
    [
        "category" => "gk",
        "q" => "What is 'IMF'?",
        "opt" => ["International Monetary Fund", "Indian Money Forum", "Instant Money Fund"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Your name123", "Mix of letters, numbers, and symbols", "12345678"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Waiting at bus stop", "Free access to luxury airport waiting areas", "Hotel room"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Expensive stock", "Very low-priced, high-risk stock", "Stock of a bank"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Changes with market conditions", "Fixed for 10 years", "Only for farmers"],
        "ans" => 0,
    ...
    [
        "category" => "daily",
        "q" => "What is 'NLP'?",
        "opt" => ["Natural Language Processing", "New Logic Power", "Net Life Price"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["For any personal use", "Only for car", "Only for education"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Time for snacks", "30 mins added after draw", "Half time"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Free currency", "No extra fee for spending in foreign currency", "Zero tax"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Money for vacation", "Savings for unexpected expenses", "Investment in stocks"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Biker", "Additional benefit like Accidental Death", "Agent name"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["10 yards", "12 yards", "15 yards"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Learning to spend", "Help with debt management and budgeting", "Applying for cards"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Middle seat", "Most expensive cabin with luxury seats and food", "Standard seat"],
        "ans" => 1,
    ...
    [
        "category" => "trading",
        "q" => "What is 'Slippage'?",
        "opt" => ["Falling down", "Difference between expected and actual price", "Fast trading"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["On sale", "Products made in very small numbers to increase value", "Free items"],
        "ans" => 1,
    ...
    [
        "category" => "auto",
        "q" => "What is 'Supercar'?",
        "opt" => ["Big car", "High-performance, expensive sports car (e.g. Ferrari)", "Electric car"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["T-shirt", "Electronic devices worn on the body (e.g. Smartwatch)", "Portable charger"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Prices are rising", "Prices are falling", "Stable prices"],
        "ans" => 1,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'Sensex'?",
        "opt" => ["BSE Index", "NSE Index", "Crypto index"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Cost Per Click", "Cost Per Customer", "Cash Plus Credit"],
        "ans" => 0,
    ...
    [
        "category" => "investing",
        "q" => "What is 'Portfolio'?",
        "opt" => ["A type of bag", "Collection of all your investments", "Company's bank account"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["School test", "Comparing two versions of a page to see which performs better", "Testing software"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'Gold Loan'?",
        "opt" => ["Buying gold", "Loan taken by pledging gold jewelry", "Free gold"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Personal savings", "State-owned investment fund", "A charity"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Number of floors", "Total area of the property", "Cost per foot"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Submarine cover", "Cargo and ship insurance", "Fish insurance"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'IoT'?",
        "opt" => ["Internet of Tasks", "Internet of Things", "Input output tech"],
        "ans" => 1,
    ...
    [
        "category" => "luxury",
        "q" => "What is 'Caviar'?",
        "opt" => ["Salt", "Salt-cured roe (eggs) of sturgeon fish", "A type of fruit"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Best scorer", "Best young player in Europe", "Most handsome player"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'OPD Cover'?",
        "opt" => ["Operation Room cover", "Outpatient Department cover (Doctor visits)", "Oxygen cover"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Free trial", "Time to cancel policy after buying (15 days)", "Waiting for claim"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A type of tax", "Share of company profit given to shareholders", "Bank interest"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["AI that only searches", "AI that can create new content (images, text)", "Robot arm"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Time at hospital", "Time before certain diseases are covered", "Appointment time"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Page with a bridge", "Intermediary page between an ad and the offer", "A homepage"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bank's door", "Software that processes online payments", "A credit card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Auto Record", "Augmented Reality", "Aero Ray"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'COD'?",
        "opt" => ["Code on delivery", "Cash on Delivery", "Cost on demand"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Interest on principal only", "Interest on principal + interest", "Zero interest"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fuel for cars", "Transaction fee paid to miners", "Account opening fee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Benzema", "Cristiano Ronaldo", "Neymar"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'MySQL'?",
        "opt" => ["A website", "A database management system", "A programming language"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Cost of borrowing money", "Bank's address", "Monthly fee"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["For buying books", "Loan for higher studies/tuition", "Loan for teachers"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Total bill", "Smallest payment to avoid late fees", "Zero payment"],
        "ans" => 1,
    ...
    [
        "category" => "gk",
        "q" => "What is 'GDP'?",
        "opt" => ["General Debt Plan", "Gross Domestic Product", "Global Deposit Price"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Messi", "Mbappé", "Julian Alvarez"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Lead Time'?",
        "opt" => ["Time to lead", "Time between placing an order and receiving it", "Meeting time"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Food", "Small file storing site preferences", "Browser virus"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurer pays all", "Insured pays a fixed % of the bill", "Paying for two people"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Working in snow", "Sending messages to people who don't know you", "Customer support"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Firewall'?",
        "opt" => ["Physical wall", "Security system that blocks unauthorized access", "Computer fan"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Text on a boat", "The clickable text in a hyperlink", "Website title"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Content about trees", "Content that remains relevant for a long time", "News updates"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Amazon workers", "Amazon's affiliate marketing program", "Prime members"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'GPU'?",
        "opt" => ["General Power Unit", "Graphics Processing Unit", "Gaming Play Unit"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Localhost'?",
        "opt" => ["A nearby shop", "Your own computer used as a server", "Free wifi"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Broken phone", "Smartphone with a flexible display that folds", "Small phone"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling all stocks", "Adjusting asset weights in a portfolio", "Adding more cash"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'Botnet'?",
        "opt" => ["Robot net", "Network of infected computers controlled by hackers", "Fast internet"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Cost of living", "Annual fee charged by mutual funds", "Personal tax"],
        "ans" => 1,
    ...
    [
        "category" => "gadgets",
        "q" => "What is 'Router'?",
        "opt" => ["A tool", "Device that sends internet to your gadgets", "Cable"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Saying thank you", "Increase in property value", "Building a house"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["USA, Mexico, Canada", "China", "England"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Setting clock", "Strategy for teams working in different hours", "Jet lag"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling ads", "Creating valuable content to attract audience", "Buying articles"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Large villa", "One room with kitchen and bedroom combined", "A music studio"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Slow storage", "Solid State Drive (Fast storage)", "Memory"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Local market", "Economy becoming more advanced and engaged with global markets", "Closed economy"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fast loading", "Websites that look good on all devices/screens", "Colorful design"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Canned meat", "Unsolicited, irrelevant messages sent in bulk", "Social posts"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Budgeting'?",
        "opt" => ["Spending freely", "Plan for income and expenses", "Paying taxes"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fighting", "Trying every possible password", "Slow internet"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Pele", "Gianni Infantino", "Zidane"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Foreign Exchange", "Forward Exit", "Foreign Exit"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Type of policy", "Third Party Administrator for claims", "A insurance agent"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for 1 person", "Insurance for employees/group", "Family plan only"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Connecting people", "Connecting physical devices to the internet", "New browser"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["For every employee", "Insurance for a crucial person in business", "For house keys"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Any Time Money", "Automated Teller Machine", "Auto Tech Money"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fast racing", "Realistic lighting and reflection technology", "Map tracking"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is '5G'?",
        "opt" => ["5th Generation mobile network", "5 Gigabytes", "5 Google servers"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Link to previous page", "Link from an external site to your site", "Broken link"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Learning underwater", "ML based on neural networks", "Complex coding"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Real Madrid", "PSG", "Bayern Munich"],
        "ans" => 0,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'NASDAQ'?",
        "opt" => ["Indian Stock Exchange", "American Tech-heavy Exchange", "Crypto coin"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Real Madrid", "Manchester City", "Inter Milan"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Only one channel", "Unified experience across web, app, store", "Many TVs"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Cashback", "Increase in cover for not claiming", "Free medicines"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Paying more tax", "Money back when you overpay tax", "A penalty"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A type of advertisement", "Code to tell Google which version of a page is the main one", "Website logo tag"],
        "ans" => 1,
    ...
    [
        "category" => "sports",
        "q" => "What is 'Serie A'?",
        "opt" => ["German league", "Italian league", "Brazilian league"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Winter clothes", "Luxury clothing designed for holidays/beaches", "Work suit"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Cristiano Ronaldo", "Lionel Messi", "Johan Cruyff"],
        "ans" => 1,
    ...
    [
        "category" => "marketing",
        "q" => "What is 'ROAS'?",
        "opt" => ["Return on Ad Spend", "Rate of All Sales", "Return on Assets"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Subdomain", "Extra domain hosted on same account", "New hosting"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Sending spam", "Sending targeted messages to a list", "Texting"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is 'Overdraft'?",
        "opt" => ["Credit card", "Withdrawing more money than in account", "Savings"],
        "ans" => 1,
    ...
    [
        "category" => "marketing",
        "q" => "What is 'Socialism'?",
        "opt" => ["Private profit", "System where means of production are owned by community/state", "A social media app"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Reading charts", "Checking financial health and earnings", "Following influencers"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Customer Relationship Management", "Cash Record Manager", "Core Resource Main"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Market is closed", "Frequency and size of price swings", "Stable market"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Digging for gold", "Validating transactions via hardware", "Buying coins"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Group of friends", "Platform that connects brands with affiliates", "Internet cable"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Long Term View", "Total revenue a business expects from one customer", "Loan To Value"],
        "ans" => 1,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'Staking'?",
        "opt" => ["Selling coins", "Locking coins to earn rewards", "Gambling"],
        "ans" => 1,
    ...
    [
        "category" => "sports",
        "q" => "What is the 'MLS'?",
        "opt" => ["Major League Soccer (USA)", "Multi League", "Main Soccer"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Fast internet", "Privacy and accessing region-locked content", "Hardware security"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["For family only", "Policy provided by employers to employees", "Government scheme"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Time to sleep", "Amount of time a user spends on a page before leaving", "Loading speed"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying groceries", "Professional who helps you buy luxury items", "Online bot"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Full match", "Tactical system from Netherlands", "Only defense"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Interest rate", "Duration of the loan", "Maximum loan amount"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Prices are rising", "Prices are falling", "Stable market"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Website design", "Server-side logic and database management", "Writing blogs"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Retirement fee", "Fixed fee to buy a player without club negotiation", "Loan fee"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Physical disk", "Storage space for website files", "RAM"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'ClickBank'?",
        "opt" => ["A traditional bank", "Popular affiliate marketplace for digital products", "A keyboard"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Hiding website", "Hiding owner's personal contact info", "Password"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Recession'?",
        "opt" => ["High growth", "Two consecutive quarters of negative GDP growth", "Stable market"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'SMTP'?",
        "opt" => ["Website protocol", "Simple Mail Transfer Protocol", "Social Media Tool"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Price of 1 coin", "Total value of all circulating coins", "Daily trading volume"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["3rd Party Logistics", "3 Player League", "3 Point Link"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Safe loan", "Loan without any collateral", "Gold loan"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Type of tax", "Withdrawing more than balance", "Bank closure"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Linking to home", "Linking to a specific product page instead of homepage", "Hidden links"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Teacher in class", "Training AI using labeled data", "AI that doesn't learn"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Free card", "Card with high fees and luxury benefits", "Basic card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Selling a room", "Tenant renting to another person", "Buying a house"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Cleaning a house", "Buying cheap, renovating, and selling fast", "Living in a house"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Monthly rent", "Initial payment made when buying home", "Final payment"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Geography test", "Earning in strong currency, spending in weak currency", "Map reading"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["France", "Germany", "Netherlands"],
        "ans" => 1,
    ...
    [
        "category" => "finance",
        "q" => "What is a 'Bond'?",
        "opt" => ["Legal glue", "Loan to government or company", "Stock share"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Order to buy at best available price", "Buying after market closes", "Order with a fixed price"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Private server", "Multiple sites on one server", "Offline hosting"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Energy Vehicle", "Electric Vehicle", "Engine Version"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Ferrari", "Volkswagen Group", "Tata Motors"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Braking that charges battery", "Faster braking", "Automatic braking"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Oxygen", "Carbon Dioxide", "Nitrogen"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Speed", "Rotational force/Acceleration power", "Fuel capacity"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bugatti Chiron", "Rimac Nevera", "Koenigsegg Jesko Absolut"],
        "ans" => 2,
    ...
    [
        ...
        "opt" => ["Fast Speed Driving", "Full Self-Driving", "Fuel Saving Device"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Only electric", "Uses both fuel engine and electric motor", "Hydrogen only"],
        "ans" => 1,
    ...
    [
        "category" => "f1",
        "q" => "What is 'ADAS'?",
        "opt" => ["Advanced Driver Assistance Systems", "Auto Data Alert System", "Air Drag Analysis"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Mahindra", "Tata Motors", "Reliance"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Type of petrol", "Generates electricity from hydrogen with zero emission", "Battery type"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Speed of a horse", "Unit of measurement for engine power", "Weight of engine"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Miles Per Gallon", "Meter Per Gram", "Maximum Power Gain"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Better battery", "Device that forces more air into engine for power", "A fast gear"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Ford F-Series", "Toyota Corolla", "VW Golf"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fast engine", "Tesla's high-speed charging station", "Engine part"],
        "ans" => 1,
    ...
    [
        "category" => "auto",
        "q" => "What is 'VIN'?",
        "opt" => ["Vehicle Identification Number", "Very Important Note", "Vehicle Insurance Net"],
        "ans" => 0,
    ...
    [
        ...
        "opt" => ["Bentley", "Rolls-Royce", "Maybach"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Controlling a ship", "Maintaining a constant speed automatically", "Parking help"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Diesel", "Petrol (Gasoline)", "CNG"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Hacking a hospital", "Making small lifestyle changes to improve health", "Cloning"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Eating only fruits", "Cycling between periods of eating and fasting", "No water"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Buying medicines online", "Consulting doctors via video/phone", "TV health shows"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Vitamin C", "Vitamin D", "Vitamin B12"],
        "ans" => 1,
    ...
    [
        "category" => "fitness",
        "q" => "What is 'Cortisol'?",
        "opt" => ["Muscle builder", "The body's main stress hormone", "Type of sugar"],
        "ans" => 1,
    ...
    [
        "category" => "fitness",
        "q" => "What is 'BMI'?",
        "opt" => ["Body Muscle Index", "Body Mass Index", "Basic Metabolic Intake"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Digital clothes", "Devices like Apple Watch/Fitbit for health tracking", "Hearing aids"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Insurance for brain surgery", "Coverage for therapy and psychiatric care", "Memory loss cover"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Doctor's diary", "Patient's own collection of their health data", "Insurance card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Antibiotics", "Live beneficial bacteria for gut health", "Protein powder"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Melatonin'?",
        "opt" => ["Skin color", "Hormone that regulates sleep-wake cycles", "Stress hormone"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Emergency care", "Checkups and tests to find diseases early", "Surgery"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Private insurance", "System where everyone gets health services without hardship", "Free medicine only"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Eating more", "Burning more calories than you consume", "Low protein"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Types of fats", "Substances that protect cells from damage", "Acidic food"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Sleeping 10 hours", "The stage of sleep for body repair and growth", "Dreaming stage"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["High sugar diet", "High-fat, low-carb diet", "Only protein diet"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bad cholesterol", "Good cholesterol", "Neutral"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Blood group test", "Analyzing DNA to identify health risks", "IQ test"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bank account for shopping", "Tax-advantaged account for medical expenses", "Free clinic"],
        "ans" => 1,
    ...
    [
        "category" => "fitness",
        "q" => "What is 'Gluten'?",
        "opt" => ["A sugar", "Protein found in wheat, barley, and rye", "A fruit"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Exercise", "Training the mind for focus and stress reduction", "Sleeping"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Heart beat", "The body's internal 24-hour clock", "Running speed"],
        "ans" => 1,
    ...
    [
        "category" => "fitness",
        "q" => "What is 'Superfood'?",
        "opt" => ["Huge fruit", "Nutrient-rich food beneficial for health", "Fast food"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Common fever", "Life-threatening disease like Cancer or Stroke", "Small injury"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Changing phone", "Fraudster taking over your phone number for OTPs", "New SIM card"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Bank account", "Scam that pays old investors with new investors' money", "Government bond"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Washing cash", "Making illegal money look like legal income", "Printing money"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Card cleaning", "Devices that steal card data during swipe", "Free cash"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Losing card", "Fraudulent transaction where the card is not physically shown", "ATM theft"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Fishing for whales", "Phishing targeted at high-level executives", "Large virus"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Gym workout", "Artificially inflating stock price then selling", "Water pump"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'KYC' for?",
        "opt" => ["Keeping Your Cash", "Verifying the identity of bank customers", "Knowing Your City"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Closing account", "Hacker gaining control of a legitimate user account", "Opening new account"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Farmer's account", "Account used to transfer stolen money for others", "Empty account"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Unsafe payment", "Payment protected by scrambling data", "Physical cash"],
        "ans" => 1,
    ...
    [
        "category" => "daily",
        "q" => "What is 'Pharming'?",
        "opt" => ["Growing crops", "Redirecting users to fake websites automatically", "Hacking a pharmacy"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Funny ads", "Using online advertisements to spread malware", "TV ads"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Government control", "No single central authority or server", "Focusing on one city"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Digital Auto Office", "Decentralized Autonomous Organization", "Daily Asset Only"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Digging in ground", "Solving complex math to secure network and earn coins", "Buying coins"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Physical leather wallet", "Software/Device to store private keys and access crypto", "A bank branch"],
        "ans" => 1,
    ...
    [
        "category" => "energy",
        "q" => "What is 'Gas Fee'?",
        "opt" => ["Car fuel", "Transaction fee on the Ethereum network", "Electricity bill"],
        "ans" => 1,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'Altcoin'?",
        "opt" => ["Fake coin", "Any cryptocurrency other than Bitcoin", "A gold coin"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["School book", "A distributed and public record of all transactions", "Bank's computer"],
        "ans" => 1,
    ...
    [
        "category" => "tech",
        "q" => "What is 'DApp'?",
        "opt" => ["Daily App", "Decentralized Application", "Data App"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Working in office", "A consensus mechanism for verifying crypto transactions", "A job certificate"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Betting", "Verifying transactions based on coins held/staked", "Ownership paper"],
        "ans" => 1,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'HODL'?",
        "opt" => ["Holding cash", "Slang for holding crypto long-term despite price drops", "Fast trading"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Swimming pool", "Crowdsourced pool of tokens used for trading on DEX", "Bank's cash"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["A tech company", "Pseudonym of the creator of Bitcoin", "A Japanese bank"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Slow speed", "High-speed and low-cost blockchain transactions", "First crypto"],
        "ans" => 1,
    ...
    [
        ...
        "opt" => ["Storing in fridge", "Storing crypto offline for maximum security", "Bank locker"],
        "ans" => 1,
    ...
    [
        "category" => "crypto",
        "q" => "What is 'FOMO'?",
        "opt" => ["Focus On Money Only", "Fear Of Missing Out", "Fast Online Money Offer"],
        "ans" => 1,
...
foreach ($questions_array as $item) {
    ...
    $q = $conn->real_escape_string($item['q']);
    $o1 = $conn->real_escape_string($item['opt'][0]);
    $o2 = $conn->real_escape_string($item['opt'][1]);
    $o3 = $conn->real_escape_string($item['opt'][2]);
    $o4 = $conn->real_escape_string($item['opt'][3]);
    $ans = (int)$item['ans'];
    $exp = $conn->real_escape_string($item['exp']);

    // INSERT IGNORE વાપરવાથી ડુપ્લીકેટ પ્રશ્નો એડ નહીં થાય
    $sql = "INSERT IGNORE INTO questions (category, q, option1, option2, option3, option4, ans, exp) 
            VALUES ('$cat', '$q', '$o1', '$o2', '$o3', '$o4', $ans, '$exp')";
    
    if($conn->query($sql)) {
        if ($conn->affected_rows > 0) {
            $added_count++; // નવો પ્રશ્ન ઉમેરાયો
        } else {
            $duplicate_count++; // ડુપ્લીકેટ હતો એટલે સ્કીપ થયો
        }
    }
}

echo "<h2>અપલોડ રિપોર્ટ:</h2>";
echo "નવા ઉમેરાયેલા પ્રશ્નો: $added_count <br>";
echo "ડુપ્લીકેટ (સ્કીપ કરેલા): $duplicate_count";
